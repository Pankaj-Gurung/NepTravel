    ...
    <div className=" min-h-screen flex flex-col lg:flex-row items-center md:mx-32 mx-5 gap-14">
      <div className=" w-full lg:w-2/4">
        <div className=" space-y-4 ">
          ...
          <p>
            Discover the Best Holiday Experiences with NepTravie! We're
            dedicated to curating the latest and greatest destinations from
            around the Nepal, ensuring you always get the ultimate travel
            experience.
          </p>
        </div>
      ...
      <div className=" w-full lg:w-2/4 space-y-10 relative top-10">
        ...
        <div className=" flex flex-row gap-5 relative top-7">
        ...
        <div className=" flex flex-row gap-5 relative top-20">
          <div className="flex flex-row items-center w-24">
